...
The single most useful thing you can send is what you were doing and what
happened instead of what you expected. After that:

- Which episode, if it was one particular episode.
- Which browser, and which device. The web app is the only released build.
- **For anything to do with audio: attach the playback diagnostics.** Open the
  drawer in the app, choose **Playback diagnostics**, copy the text and paste it
  into the email. It records how long each load took, where playback stopped, and
  any control press that did not take effect. It contains no audio, no URLs and
  no account identifier. It exists because two playback faults were once reported
...
Send it to the same address. [4a's privacy policy](/4a/privacy/) is exact about
...
## Writing about longlive

[longlive](/longlive/) has its own site at
[longlivets.com](https://longlivets.com/), and anything specific to it —
including a correction to something on its timeline — belongs there. Company-level
correspondence about it can come to the address above.

## Legal and business correspondence

The same address reaches {{ORG}}, {{ORG_FORM}}. Our [terms of use](/terms/) name
the company and this address as the point of contact for notices.
